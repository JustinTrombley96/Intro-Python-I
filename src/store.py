...
class Store:
    ...
    # add a __str__ method so that we can observe our Store instance
    def __str__(self):
...
# let's take input from the user and have them specify departments by the department
